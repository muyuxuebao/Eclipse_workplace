package com.yinliang.maven.maven_CommonsCLI;
...
public class App {
	public static void main(String[] args) {
		...
		opt.addOption(OptionBuilder.withArgName("file").hasArg()
				.withDescription("search for buildfile towards the root of the filesystem and use it").create("O"));
		opt.addOption(OptionBuilder.withLongOpt("block-size").withDescription("use SIZE-byte blocks")
		...
		if (cl.hasOption("O")) {
			System.out.println("file = " + cl.getOptionValue("O"));
		}
